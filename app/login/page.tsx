    ...
    >
      ...
      <div
        ...
        style={{
          ...
          boxShadow: "0 0 60px rgba(255, 215, 0, 0.05), 0 25px 50px rgba(0,0,0,0.5)",
        }}
      >
        {/* Logo / Brand */}
        <div className="text-center mb-8">
          ...
          >
            <span className="text-2xl font-bold" style={{ color: "#FFD700" }}>E</span>
          </div>
          <h1
        ...
        <button
          ...
          onMouseEnter={(e) => {
            if (!loading) {
              (e.target as HTMLButtonElement).style.boxShadow = "0 0 30px rgba(255, 215, 0, 0.5)";
              (e.target as HTMLButtonElement).style.transform = "translateY(-1px)";
            }
          }}
          onMouseLeave={(e) => {
            if (!loading) {
              (e.target as HTMLButtonElement).style.boxShadow = "0 0 20px rgba(255, 215, 0, 0.3)";
